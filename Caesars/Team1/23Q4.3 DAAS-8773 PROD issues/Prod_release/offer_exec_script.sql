...
-- Step 2) Change the warehouse of the trip jobs to 4xl warehouse
...
CALL DAAS_ADHOC.OFFER_EXTRA_SK_ADHOC_PROC();
...
CALL DAAS_ADHOC.OFFER_CLEANUP_ADHOC_PROC(LOWER_LIMIT,UPPER_LIMIT);
