CREATE OR REPLACE PROCEDURE DAAS_ADHOC.OFFER_CLEANUP_ADHOC_PROC(LOWER_LIMIT INT,UPPER_LIMIT INT)
...
try
{
	...
	update_query = snowflake.execute( {sqlText: `UPDATE DAAS_CORE.TRIP_DETAIL
						...
						WHERE TRANSACTION_TABLE_SK IN (SELECT DISTINCT TRANSACTION_TABLE_SK FROM DAAS_TEMP.OFFERS_EXTRA_SKS_CLEANUP_TRIPS 
