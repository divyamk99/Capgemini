CREATE OR REPLACE PROCEDURE DAAS_COMMON.ET_BOUNCES_EVENT_HISTORY_EXTRACT_PROC()
...
##########################################################################################
Author: Divya
Purpose: Load historical data from S3 to Stage (DAAS_STG_EXACT_TARGET.ET_BOUNCES_EVENT_STG) 
##########################################################################################
*/
